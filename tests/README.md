...
--- ALGORITHMIC PERFORMANCE VERIFICATION ---
  ...
  /v1/generiques?group={id}: 244390.5 req/sec (claimed: 200000.0 req/sec, diff: 22.2%)
  /v1/generiques?group={id}: 4.0 µs (claimed: 5.0 µs, diff: -20.0%)
...
✅ PASS /v1/generiques?group={id} algorithmic throughput: 244390.5 req/sec (claimed: 200000.0 req/sec, diff: 22.2%)
✅ PASS /v1/generiques?group={id} algorithmic latency: 4.0 µs (claimed: 5.0 µs, diff: -20.0%)
...
- `/v1/generiques?group={id}`: 200,000 req/sec, 5.0µs latency
